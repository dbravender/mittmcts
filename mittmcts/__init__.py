...
class Node(object):
    def __init__(self, game, state, parent, move, c, depth=0,
                 evaluation_function=ucb1, determined=False):
        self.__slots__ = ('parent', '__state', '__initial_state', '__children',
                          ...
                          'determined_unvisited_children', 'evaluation_function')
        self.parent = parent
        self.__state = state
        if parent is None:
    ...
    def get_best_child(self):
        ...
        children = sorted(children, key=lambda c: self.evaluation_function(
